...
import { kycCurrentStatus , notifyKycStatus , verifyKyc , updateKycStatus} from '../controller/kycStatus';
...
router.get('/service/kyc/status',isTokenValid, kycCurrentStatus);
