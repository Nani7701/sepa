...
INSERT INTO `country` (`country_id`, `country_name`, `calling_code`, `country_code`, `currency`, `currency_symbol`, `status`, `created_on`, `updated_on`, `country_flag_img_path`) VALUES
	...
	(2, 'EURO', 00, 'EU', 'EUR', '£', 1, NULL, '2019-08-29 15:21:07', '/images/country_flag_img_path/euroFlag@3x.png'),
...
CREATE TABLE `payment_cards` (
  ...
  `card_month` varchar(5) DEFAULT NULL,
...
CREATE TABLE `sceduled_transfer` (
  `id` smallint(6) NOT NULL AUTO_INCREMENT,
  `refference_number` varchar(15) DEFAULT NULL,
  `applicant_id` int(11) NOT NULL,
  `transfer_time` datetime NOT NULL,
  `from_currency` varchar(5) DEFAULT NULL,
  `list_of_transaction` longtext DEFAULT NULL,
  `status` tinyint(4) unsigned zerofill DEFAULT 0,
...
CREATE TABLE `user_counterparty` (
  ...
  `counterparty` smallint(6) DEFAULT NULL,
