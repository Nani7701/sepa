...
export class PersonalSignupComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.perSignUpFormm = this.fb.group({
      ...
      Validators.email, Validators.pattern("[A-Za-z._-]+\(|[0-9])+\(|[A-Za-z0-9._-])+@[A-Za-z0-9._%-]+\\.[a-z]{2,3}")])],
      ...
      postal_code: ['', Validators.compose([Validators.required, this.ValidatePostal, , this.noWhitespace])],
      ...
      region: ["", Validators.compose([Validators.required, Validators.pattern('^[a-zA-Z ]*$'), this.noWhitespace])],
