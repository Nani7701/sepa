...
export class AddressModel {
	...
	getAddressDetails(applicantId) {
		return new Promise((resolve, reject) => {
			...
			let sql = `SELECT a.address_type_id , a.address_line1,a.address_line2,a.city,a.town,a.postal_code,a.region,c.country_name,ad.address_type FROM address a,country c,address_type ad WHERE a.applicant_id = ${applicantId} and c.country_id = a.country_id and ad.address_type_id = a.address_type_id`;
